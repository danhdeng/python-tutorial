class ShoppingCart:
    ...
    def add_item(self, item, qty):
        """
        Accepts an item tupble (name, price) and qty and updates items_in_cart dictionary
        : param item: string name of item to add
        : param qty: quantity of item to to add
        : return : None
        """
        ...
        try:
            ...
            print("There was an error wihile adding items to cart")
            print(e)

        except Exception as e:
            print("There was an general error wihile adding items to cart")
            print(e)
